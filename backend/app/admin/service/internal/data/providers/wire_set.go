...
var ProviderSet = wire.NewSet(
	...
	data.NewStockLotServiceClient,
	data.NewStockPickingServiceClient,

	data.NewApprovalRequestServiceClient,
	data.NewApprovalFlowServiceClient,
	data.NewAccountingServiceClient,
	...
	data.NewPayableServiceClient,
	data.NewPaymentServiceClient,
	data.NewReceivableServiceClient,
	data.NewReceiptServiceClient,
	data.NewFinanceReportServiceClient,

	data.NewCustomerServiceClient,
	data.NewSalesOrderServiceClient,
	data.NewBillingServiceClient,
	data.NewPlanAdminServiceClient,
