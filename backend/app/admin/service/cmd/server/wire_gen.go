...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	approvalFlowServiceClient := data.NewApprovalFlowServiceClient(context, discovery)
	approvalFlowService := service.NewApprovalFlowService(context, approvalFlowServiceClient)
	...
	accountingServiceClient := data.NewAccountingServiceClient(context, discovery)
	accountingService := service.NewAccountingService(context, accountingServiceClient)
