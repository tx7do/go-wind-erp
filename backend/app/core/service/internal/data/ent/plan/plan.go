...
const (
	...
	// FieldMaxOrdersMonthly holds the string denoting the max_orders_monthly field in the database.
	FieldMaxOrdersMonthly = "max_orders_monthly"
...
var (
	...
	DefaultMaxUsers int64
	// DefaultMaxOrdersMonthly holds the default value on creation for the "max_orders_monthly" field.
	DefaultMaxOrdersMonthly int64
...
// ByMaxOrdersMonthly orders the results by the max_orders_monthly field.
func ByMaxOrdersMonthly(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldMaxOrdersMonthly, opts...).ToFunc()
}
