...
func (_q *PaymentQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *PaymentQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *PaymentQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *PaymentQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *PaymentQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *PaymentQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *PaymentQuery) prepareQuery(ctx context.Context) error {
	...
	if err := payment.Policy.EvalQuery(ctx, _q); err != nil {
		return err
	}
	return nil
}
