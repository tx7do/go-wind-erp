...
func (_q *CustomerQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CustomerQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *CustomerQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *CustomerQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *CustomerQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *CustomerQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *CustomerQuery) prepareQuery(ctx context.Context) error {
	...
	if customer.Policy == nil {
		return errors.New("ent: uninitialized customer.Policy (forgotten import ent/runtime?)")
	}
...
func (_q *CustomerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(customer.Table, customer.Columns, sqlgraph.NewFieldSpec(customer.FieldID, field.TypeUint32))
	_spec.From = _q.sql
