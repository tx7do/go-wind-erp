...
var (
	...
	AprApprovalRequestsColumns = []*schema.Column{
		...
		{Name: "tenant_id", Type: field.TypeUint32, Nullable: true, Comment: "租户ID", Default: 0},
		{Name: "title", Type: field.TypeString, Nullable: true, Comment: "审批标题"},
		{Name: "biz_type", Type: field.TypeString, Nullable: true, Comment: "业务类型"},
		{Name: "biz_ref", Type: field.TypeString, Nullable: true, Comment: "业务单据引用"},
		{Name: "summary", Type: field.TypeString, Nullable: true, Comment: "事由摘要"},
		{Name: "status", Type: field.TypeEnum, Nullable: true, Comment: "审批状态", Enums: []string{"PENDING", "APPROVED", "REJECTED", "CANCELLED"}, Default: "PENDING"},
	...
	AprApprovalRequestsTable = &schema.Table{
		Name:       "apr_approval_requests",
		Comment:    "审批请求表",
		Columns:    AprApprovalRequestsColumns,
		PrimaryKey: []*schema.Column{AprApprovalRequestsColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "idx_apr_request_tenant_status_created_at",
				Unique:  false,
				Columns: []*schema.Column{AprApprovalRequestsColumns[8], AprApprovalRequestsColumns[13], AprApprovalRequestsColumns[1]},
			},
			{
				Name:    "idx_apr_request_tenant_applicant_created_at",
				Unique:  false,
				Columns: []*schema.Column{AprApprovalRequestsColumns[8], AprApprovalRequestsColumns[14], AprApprovalRequestsColumns[1]},
			},
		},
	}
	...
	// InvWarehousesColumns holds the columns for the "inv_warehouses" table.
	InvWarehousesColumns = []*schema.Column{
		{Name: "id", Type: field.TypeUint32, Increment: true, Comment: "id"},
		{Name: "created_at", Type: field.TypeTime, Nullable: true, Comment: "创建时间"},
		{Name: "updated_at", Type: field.TypeTime, Nullable: true, Comment: "更新时间"},
		{Name: "deleted_at", Type: field.TypeTime, Nullable: true, Comment: "删除时间"},
		...
		{Name: "remark", Type: field.TypeString, Nullable: true, Comment: "备注"},
		{Name: "tenant_id", Type: field.TypeUint32, Nullable: true, Comment: "租户ID", Default: 0},
		{Name: "code", Type: field.TypeString, Nullable: true, Comment: "仓库编码"},
	...
	InvWarehousesTable = &schema.Table{
		Name:       "inv_warehouses",
		Comment:    "仓库表",
		Columns:    InvWarehousesColumns,
		PrimaryKey: []*schema.Column{InvWarehousesColumns[0]},
		Indexes: []*schema.Index{
			{
				Name:    "idx_inv_warehouse_tenant_code",
				Unique:  true,
				Columns: []*schema.Column{InvWarehousesColumns[8], InvWarehousesColumns[9]},
			},
		},
	}
...
func init() {
	...
	InvWarehousesTable.Annotation = &entsql.Annotation{
