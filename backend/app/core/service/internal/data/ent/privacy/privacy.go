...
// The PurchaseOrderItemQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type PurchaseOrderItemQueryRuleFunc func(context.Context, *ent.PurchaseOrderItemQuery) error

// EvalQuery return f(ctx, q).
func (f PurchaseOrderItemQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.PurchaseOrderItemQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.PurchaseOrderItemQuery", q)
}

// The PurchaseOrderItemMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type PurchaseOrderItemMutationRuleFunc func(context.Context, *ent.PurchaseOrderItemMutation) error

// EvalMutation calls f(ctx, m).
func (f PurchaseOrderItemMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.PurchaseOrderItemMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.PurchaseOrderItemMutation", m)
}
...
// The ReceivableQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type ReceivableQueryRuleFunc func(context.Context, *ent.ReceivableQuery) error

// EvalQuery return f(ctx, q).
func (f ReceivableQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.ReceivableQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.ReceivableQuery", q)
}

// The ReceivableMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type ReceivableMutationRuleFunc func(context.Context, *ent.ReceivableMutation) error

// EvalMutation calls f(ctx, m).
func (f ReceivableMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.ReceivableMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.ReceivableMutation", m)
}
...
// The SalesOrderQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type SalesOrderQueryRuleFunc func(context.Context, *ent.SalesOrderQuery) error

// EvalQuery return f(ctx, q).
func (f SalesOrderQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SalesOrderQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.SalesOrderQuery", q)
}

// The SalesOrderMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type SalesOrderMutationRuleFunc func(context.Context, *ent.SalesOrderMutation) error

// EvalMutation calls f(ctx, m).
func (f SalesOrderMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.SalesOrderMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.SalesOrderMutation", m)
}

// The SalesOrderItemQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type SalesOrderItemQueryRuleFunc func(context.Context, *ent.SalesOrderItemQuery) error

// EvalQuery return f(ctx, q).
func (f SalesOrderItemQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SalesOrderItemQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.SalesOrderItemQuery", q)
}

// The SalesOrderItemMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type SalesOrderItemMutationRuleFunc func(context.Context, *ent.SalesOrderItemMutation) error

// EvalMutation calls f(ctx, m).
func (f SalesOrderItemMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.SalesOrderItemMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.SalesOrderItemMutation", m)
}

// The StockLocationQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type StockLocationQueryRuleFunc func(context.Context, *ent.StockLocationQuery) error

// EvalQuery return f(ctx, q).
func (f StockLocationQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.StockLocationQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.StockLocationQuery", q)
}

// The StockLocationMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type StockLocationMutationRuleFunc func(context.Context, *ent.StockLocationMutation) error

// EvalMutation calls f(ctx, m).
func (f StockLocationMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.StockLocationMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.StockLocationMutation", m)
}

// The StockLotQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type StockLotQueryRuleFunc func(context.Context, *ent.StockLotQuery) error

// EvalQuery return f(ctx, q).
func (f StockLotQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.StockLotQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.StockLotQuery", q)
}

// The StockLotMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type StockLotMutationRuleFunc func(context.Context, *ent.StockLotMutation) error

// EvalMutation calls f(ctx, m).
func (f StockLotMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.StockLotMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.StockLotMutation", m)
}

// The StockMoveQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type StockMoveQueryRuleFunc func(context.Context, *ent.StockMoveQuery) error

// EvalQuery return f(ctx, q).
func (f StockMoveQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.StockMoveQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.StockMoveQuery", q)
}

// The StockMoveMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type StockMoveMutationRuleFunc func(context.Context, *ent.StockMoveMutation) error

// EvalMutation calls f(ctx, m).
func (f StockMoveMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.StockMoveMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.StockMoveMutation", m)
}

// The StockMoveLineQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type StockMoveLineQueryRuleFunc func(context.Context, *ent.StockMoveLineQuery) error

// EvalQuery return f(ctx, q).
func (f StockMoveLineQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.StockMoveLineQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.StockMoveLineQuery", q)
}

// The StockMoveLineMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type StockMoveLineMutationRuleFunc func(context.Context, *ent.StockMoveLineMutation) error

// EvalMutation calls f(ctx, m).
func (f StockMoveLineMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.StockMoveLineMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.StockMoveLineMutation", m)
}

// The StockPickingQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type StockPickingQueryRuleFunc func(context.Context, *ent.StockPickingQuery) error

// EvalQuery return f(ctx, q).
func (f StockPickingQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.StockPickingQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.StockPickingQuery", q)
}

// The StockPickingMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type StockPickingMutationRuleFunc func(context.Context, *ent.StockPickingMutation) error

// EvalMutation calls f(ctx, m).
func (f StockPickingMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.StockPickingMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.StockPickingMutation", m)
}

// The StockQuantQueryRuleFunc type is an adapter to allow the use of ordinary
// functions as a query rule.
type StockQuantQueryRuleFunc func(context.Context, *ent.StockQuantQuery) error

// EvalQuery return f(ctx, q).
func (f StockQuantQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.StockQuantQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.StockQuantQuery", q)
}

// The StockQuantMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type StockQuantMutationRuleFunc func(context.Context, *ent.StockQuantMutation) error

// EvalMutation calls f(ctx, m).
func (f StockQuantMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.StockQuantMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.StockQuantMutation", m)
}
...
// functions as a query rule.
type SupplierQueryRuleFunc func(context.Context, *ent.SupplierQuery) error

// EvalQuery return f(ctx, q).
func (f SupplierQueryRuleFunc) EvalQuery(ctx context.Context, q ent.Query) error {
	if q, ok := q.(*ent.SupplierQuery); ok {
		return f(ctx, q)
	}
	return Denyf("ent/privacy: unexpected query type %T, expect *ent.SupplierQuery", q)
}

// The SupplierMutationRuleFunc type is an adapter to allow the use of ordinary
// functions as a mutation rule.
type SupplierMutationRuleFunc func(context.Context, *ent.SupplierMutation) error

// EvalMutation calls f(ctx, m).
func (f SupplierMutationRuleFunc) EvalMutation(ctx context.Context, m ent.Mutation) error {
	if m, ok := m.(*ent.SupplierMutation); ok {
		return f(ctx, m)
	}
	return Denyf("ent/privacy: unexpected mutation type %T, expect *ent.SupplierMutation", m)
}
...
func queryFilter(q ent.Query) (Filter, error) {
	...
	case *ent.RolePermissionQuery:
		return q.Filter(), nil
	case *ent.SalesOrderQuery:
		return q.Filter(), nil
	case *ent.SalesOrderItemQuery:
		return q.Filter(), nil
	case *ent.StockLocationQuery:
		return q.Filter(), nil
	case *ent.StockLotQuery:
		return q.Filter(), nil
	case *ent.StockMoveQuery:
		return q.Filter(), nil
	case *ent.StockMoveLineQuery:
		return q.Filter(), nil
	case *ent.StockPickingQuery:
		return q.Filter(), nil
	case *ent.StockQuantQuery:
		return q.Filter(), nil
...
func mutationFilter(m ent.Mutation) (Filter, error) {
	...
	case *ent.PurchaseOrderMutation:
		return m.Filter(), nil
	case *ent.PurchaseOrderItemMutation:
		return m.Filter(), nil
	case *ent.ReceiptMutation:
		return m.Filter(), nil
	case *ent.ReceivableMutation:
		return m.Filter(), nil
	...
	case *ent.RolePermissionMutation:
		return m.Filter(), nil
	case *ent.SalesOrderMutation:
		return m.Filter(), nil
	case *ent.SalesOrderItemMutation:
		return m.Filter(), nil
	case *ent.StockLocationMutation:
		return m.Filter(), nil
	case *ent.StockLotMutation:
		return m.Filter(), nil
	case *ent.StockMoveMutation:
		return m.Filter(), nil
	case *ent.StockMoveLineMutation:
		return m.Filter(), nil
	case *ent.StockPickingMutation:
		return m.Filter(), nil
	case *ent.StockQuantMutation:
		return m.Filter(), nil
	case *ent.SubscriptionMutation:
		return m.Filter(), nil
	case *ent.SupplierMutation:
		return m.Filter(), nil
