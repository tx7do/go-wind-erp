...
const (
	...
	// FieldReceivableID holds the string denoting the receivable_id field in the database.
	FieldReceivableID = "receivable_id"
...
var (
	...
	// DefaultReceivableID holds the default value on creation for the "receivable_id" field.
	DefaultReceivableID uint32
...
func MethodValidator(m Method) error {
	...
	case MethodBankTransfer, MethodCash, MethodCheck, MethodOther:
		return nil
	default:
		return fmt.Errorf("receipt: invalid enum value for method field: %q", m)
	}
}
...
// ByReceivableID orders the results by the receivable_id field.
func ByReceivableID(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldReceivableID, opts...).ToFunc()
}
