...
var ProviderSet = wire.NewSet(
	...
	data.NewWarehouseRepo,
	data.NewLocationRepo,
	data.NewStockQuantRepo,
	data.NewStockLotRepo,
	data.NewStockMoveRepo,
	data.NewStockMoveLineRepo,
	...
	data.NewProductRepo,
	data.NewPurchaseOrderRepo,

	data.NewPayableRepo,
	data.NewPaymentRepo,

	data.NewCustomerRepo,
	data.NewSalesOrderRepo,

	data.NewReceivableRepo,
	data.NewReceiptRepo,
