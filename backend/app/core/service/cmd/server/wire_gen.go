...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	stockMovementService := service.NewStockMovementService(context, stockMovementRepo)
	...
	approvalRequestService := service.NewApprovalRequestService(context, approvalRequestRepo, purchaseOrderService)
	...
	paymentService := service.NewPaymentService(context, paymentRepo, payableRepo)
