...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	approvalRequestService := service.NewApprovalRequestService(context, approvalRequestRepo, purchaseOrderService, salesOrderService, paymentService, receiptService, internalMessageRepo, internalMessageRecipientRepo)
