...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	purchaseOrderService := service.NewPurchaseOrderService(context, purchaseOrderRepo, approvalRequestRepo, payableRepo, stockQuantRepo, locationRepo, stockPickingRepo)
	salesOrderService := service.NewSalesOrderService(context, salesOrderRepo, approvalRequestRepo, receivableRepo, locationRepo, stockPickingRepo)
