...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	inventoryRepo := data.NewInventoryRepo(context, entClient)
	stockMovementRepo := data.NewStockMovementRepo(context, entClient)
	inventoryService := service.NewInventoryService(context, inventoryRepo, warehouseRepo, stockMovementRepo)
	...
	stockMovementService := service.NewStockMovementService(context, stockMovementRepo, inventoryRepo, purchaseOrderRepo, approvalRequestRepo, internalMessageRepo, internalMessageRecipientRepo)
	payableRepo := data.NewPayableRepo(context, entClient)
	purchaseOrderService := service.NewPurchaseOrderService(context, purchaseOrderRepo, approvalRequestRepo, payableRepo, inventoryRepo)
	...
	demoDataService := service.NewDemoDataService(context, tenantService, warehouseService, productService, supplierService, inventoryService, stockMovementRepo)
	grpcServer, err := server.NewGrpcServer(context, v, authenticationService, loginPolicyService, userCredentialService, taskService, warehouseService, inventoryService, stockMovementService, approvalRequestService, supplierService, productService, purchaseOrderService, payableService, paymentService, fileService, dictTypeService, dictEntryService, languageService, tenantService, userService, roleService, positionService, orgUnitService, menuService, apiService, permissionService, permissionGroupService, permissionAuditLogService, policyEvaluationLogService, loginAuditLogService, apiAuditLogService, operationAuditLogService, dataAccessAuditLogService, internalMessageService, internalMessageCategoryService, internalMessageRecipientService, demoDataService)
	if err != nil {
		cleanup2()
		cleanup()
		return nil, nil, err
