...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	stockPickingService := service.NewStockPickingService(context, stockPickingRepo, stockQuantRepo, stockMoveLineRepo, stockLotRepo, purchaseOrderRepo, salesOrderRepo, receivableRepo, payableRepo, approvalRequestRepo, locationRepo, internalMessageRepo, internalMessageRecipientRepo)
	...
	salesOrderService := service.NewSalesOrderService(context, salesOrderRepo, approvalRequestRepo, receivableRepo, billingGuard, locationRepo, stockPickingRepo)
	paymentRepo := data.NewPaymentRepo(context, entClient)
	paymentService := service.NewPaymentService(context, paymentRepo, payableRepo, approvalRequestRepo)
	receiptRepo := data.NewReceiptRepo(context, entClient)
	receiptService := service.NewReceiptService(context, receiptRepo, receivableRepo, approvalRequestRepo)
