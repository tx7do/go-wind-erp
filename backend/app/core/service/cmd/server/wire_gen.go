...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	approvalRequestService := service.NewApprovalRequestService(context, approvalRequestRepo, purchaseOrderRepo)
	supplierRepo := data.NewSupplierRepo(context, entClient)
	supplierService := service.NewSupplierService(context, supplierRepo)
	purchaseOrderService := service.NewPurchaseOrderService(context, purchaseOrderRepo, approvalRequestRepo)
