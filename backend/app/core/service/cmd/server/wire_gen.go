...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	stockPickingService := service.NewStockPickingService(context, stockPickingRepo, stockQuantRepo, stockMoveLineRepo, purchaseOrderRepo, approvalRequestRepo, locationRepo, internalMessageRepo, internalMessageRecipientRepo)
	...
	approvalRequestService := service.NewApprovalRequestService(context, approvalRequestRepo, purchaseOrderService, paymentService, internalMessageRepo, internalMessageRecipientRepo)
