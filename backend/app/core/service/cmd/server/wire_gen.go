...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	stockMovementService := service.NewStockMovementService(context, stockMovementRepo, inventoryRepo, purchaseOrderRepo)
	approvalRequestRepo := data.NewApprovalRequestRepo(context, entClient)
	payableRepo := data.NewPayableRepo(context, entClient)
	purchaseOrderService := service.NewPurchaseOrderService(context, purchaseOrderRepo, approvalRequestRepo, payableRepo)
