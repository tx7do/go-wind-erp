...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	stockPickingService := service.NewStockPickingService(context, stockPickingRepo, stockQuantRepo, stockMoveLineRepo, purchaseOrderRepo, salesOrderRepo, approvalRequestRepo, locationRepo, internalMessageRepo, internalMessageRecipientRepo)
