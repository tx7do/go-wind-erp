...
func initApp(context *bootstrap.Context) (*kratos.App, func(), error) {
	...
	httpServer := server.NewRestServer(context, v, authenticationService, fileTransferService, userProfileService, warehouseService, stockQuantService, stockPickingService, approvalRequestService, dictEntryLookup, purchaseOrderService, payableService, paymentService)
