...
// Validate checks the field values on SelfRegisterTenantRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *SelfRegisterTenantRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on SelfRegisterTenantRequest with the
// rules defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// SelfRegisterTenantRequestMultiError, or nil if none found.
func (m *SelfRegisterTenantRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *SelfRegisterTenantRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return SelfRegisterTenantRequestMultiError(errors)
	}

	return nil
}

// SelfRegisterTenantRequestMultiError is an error wrapping multiple validation
// errors returned by SelfRegisterTenantRequest.ValidateAll() if the
// designated constraints aren't met.
type SelfRegisterTenantRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m SelfRegisterTenantRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m SelfRegisterTenantRequestMultiError) AllErrors() []error { return m }

// SelfRegisterTenantRequestValidationError is the validation error returned by
// SelfRegisterTenantRequest.Validate if the designated constraints aren't met.
type SelfRegisterTenantRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e SelfRegisterTenantRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e SelfRegisterTenantRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e SelfRegisterTenantRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e SelfRegisterTenantRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e SelfRegisterTenantRequestValidationError) ErrorName() string {
	return "SelfRegisterTenantRequestValidationError"
}

// Error satisfies the builtin error interface
func (e SelfRegisterTenantRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sSelfRegisterTenantRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = SelfRegisterTenantRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = SelfRegisterTenantRequestValidationError{}
