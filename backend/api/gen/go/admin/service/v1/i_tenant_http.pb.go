...
import (
	...
	v11 "go-wind-erp/api/gen/go/identity/service/v1"
...
func RegisterTenantServiceHTTPServer(s *http.Server, srv TenantServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/tenants", _TenantService_List34_HTTP_Handler(srv))
	r.GET("/admin/v1/tenants/{id}", _TenantService_Get35_HTTP_Handler(srv))
	r.POST("/admin/v1/tenants", _TenantService_Create27_HTTP_Handler(srv))
...
func _TenantService_List34_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
...
func _TenantService_Get35_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TenantService_Create27_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TenantService_Update21_HTTP_Handler(srv TenantServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
