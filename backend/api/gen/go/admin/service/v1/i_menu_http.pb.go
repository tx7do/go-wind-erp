...
func RegisterMenuServiceHTTPServer(s *http.Server, srv MenuServiceHTTPServer) {
	...
	r.GET("/admin/v1/menus/{id}", _MenuService_Get19_HTTP_Handler(srv))
	r.POST("/admin/v1/menus", _MenuService_Create15_HTTP_Handler(srv))
...
func _MenuService_Get19_HTTP_Handler(srv MenuServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _MenuService_Create15_HTTP_Handler(srv MenuServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
