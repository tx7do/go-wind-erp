...
import (
	...
	v11 "go-wind-erp/api/gen/go/task/service/v1"
...
func RegisterTaskServiceHTTPServer(s *http.Server, srv TaskServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/tasks", _TaskService_List33_HTTP_Handler(srv))
	r.GET("/admin/v1/tasks/type-name/{type_name}", _TaskService_Get33_HTTP_Handler(srv))
	r.GET("/admin/v1/tasks/{id}", _TaskService_Get34_HTTP_Handler(srv))
	r.POST("/admin/v1/tasks", _TaskService_Create26_HTTP_Handler(srv))
	r.PUT("/admin/v1/tasks/{id}", _TaskService_Update20_HTTP_Handler(srv))
...
func _TaskService_List33_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
...
func _TaskService_Create26_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _TaskService_Update20_HTTP_Handler(srv TaskServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
