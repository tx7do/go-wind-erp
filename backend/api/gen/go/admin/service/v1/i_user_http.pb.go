...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	...
	r.POST("/admin/v1/users", _UserService_Create30_HTTP_Handler(srv))
...
func _UserService_Create30_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
