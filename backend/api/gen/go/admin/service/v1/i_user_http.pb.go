...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/users", _UserService_List35_HTTP_Handler(srv))
	r.GET("/admin/v1/users/username/{username}", _UserService_Get36_HTTP_Handler(srv))
	r.GET("/admin/v1/users/{id}", _UserService_Get37_HTTP_Handler(srv))
	r.POST("/admin/v1/users", _UserService_Create28_HTTP_Handler(srv))
...
func _UserService_List35_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
...
func _UserService_Create28_HTTP_Handler(srv UserServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
