...
func RegisterLoginPolicyServiceHTTPServer(s *http.Server, srv LoginPolicyServiceHTTPServer) {
	r := s.Route("/")
	r.GET("/admin/v1/login-policies", _LoginPolicyService_List18_HTTP_Handler(srv))
	r.GET("/admin/v1/login-policies/{id}", _LoginPolicyService_Get18_HTTP_Handler(srv))
	r.POST("/admin/v1/login-policies", _LoginPolicyService_Create14_HTTP_Handler(srv))
...
func _LoginPolicyService_List18_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
...
func _LoginPolicyService_Get18_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
...
func _LoginPolicyService_Create14_HTTP_Handler(srv LoginPolicyServiceHTTPServer) func(ctx http.Context) error {
	return func(ctx http.Context) error {
