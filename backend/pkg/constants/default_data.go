...
var DefaultRoles = []*permissionV1.Role{
	...
	{
		Name:        trans.Ptr("仓管员"),
		Code:        trans.Ptr("sys:warehouse_keeper"),
		Status:      trans.Ptr(permissionV1.Role_ON),
		Description: trans.Ptr("仓储域角色：仓库/库存/流水/商品主数据"),
		IsProtected: trans.Ptr(false),
		Type:        trans.Ptr(permissionV1.Role_TEMPLATE),
		SortOrder:   trans.Ptr(uint32(10)),
		Permissions: []uint32{1, 3},
	},
	{
		Name:        trans.Ptr("采购员"),
		Code:        trans.Ptr("sys:purchaser"),
		Status:      trans.Ptr(permissionV1.Role_ON),
		Description: trans.Ptr("采购域角色：供应商/采购单/补货"),
		IsProtected: trans.Ptr(false),
		Type:        trans.Ptr(permissionV1.Role_TEMPLATE),
		SortOrder:   trans.Ptr(uint32(11)),
		Permissions: []uint32{1, 3},
	},
	{
		Name:        trans.Ptr("财务员"),
		Code:        trans.Ptr("sys:finance"),
		Status:      trans.Ptr(permissionV1.Role_ON),
		Description: trans.Ptr("财务域角色：应付/付款"),
		IsProtected: trans.Ptr(false),
		Type:        trans.Ptr(permissionV1.Role_TEMPLATE),
		SortOrder:   trans.Ptr(uint32(12)),
		Permissions: []uint32{1, 3},
	},
	{
		Name:        trans.Ptr("审批员"),
		Code:        trans.Ptr("sys:approver"),
		Status:      trans.Ptr(permissionV1.Role_ON),
		Description: trans.Ptr("审批域角色：审批中心"),
		IsProtected: trans.Ptr(false),
		Type:        trans.Ptr(permissionV1.Role_TEMPLATE),
		SortOrder:   trans.Ptr(uint32(13)),
		Permissions: []uint32{1, 3},
	},
}
